...
sed -i '/resolves common Indian dishes against the IFCT database/,$d' packages/pipeline/src/pipeline.corpus.test.ts
...
' packages/pipeline/src/pipeline.corpus.test.ts
